...
## Internal Variables
# nresource_manager<std::string, VAL> _nresources (_ to counter md systax)
This variable is the "wildcard" instance of a NResource Manager.

# nresource_manager<std::string, sf::Texture> _ntextures (_ to counter md systax)
This variable is the SFML texture instance of a NResource Manager.

# nresource_manager<std::string, sf::Font> _nfonts (_ to counter md systax)
This variable is the SFML font instance of a NResource Manager.

# nresource_manager<std::string, sf::SoundBuffer> _nsoundbuffers (_ to counter md systax)
